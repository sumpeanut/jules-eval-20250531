...
namespace FarmingGame.Data.Inventory
{
    ...
    public class ItemData : ScriptableObject
    {
        ...
        // Width and Height will be determined by InventoryShapeUtility based on itemShape and rotation
        // For now, we can declare them as placeholders or implement them later in step 3.
